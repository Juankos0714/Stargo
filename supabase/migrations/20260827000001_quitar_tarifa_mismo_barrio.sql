-- StarGo · No asignar tarifa automática cuando origen y destino son el mismo barrio.
-- Los barrios distintos conservan la tarifa configurada por zonas, incluso si
...
DECLARE
    ...
    v_valor        INTEGER;
BEGIN
    IF p_barrio_origen = p_barrio_destino THEN
        RETURN NULL;
    END IF;
